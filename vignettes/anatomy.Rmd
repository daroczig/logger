...
```{r loggerStructureImage, echo=FALSE, out.extra='style="width: 100%;"'}
## TODO title="The structure of a logger and the flow of a log record request"
## TODO alt="The structure of a logger and the flow of a log record request"
