---
title: "Customizing the format and destination of log records"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Customizing the format and destination of log records}
...
In this vignette I suppose that you are already familiar with [The Anatomy of a Log Request](https://daroczig.github.io/logger/articles/logger_structure.html).
...
## Log message formats and layouts
...
For other formatter and layout functions, see the manual of the above mentioned functions that have references to all the other functions and generator functions bundled with the package.
...
*So thus if you want to write your own layout generator functions, please keep `match.call()` recorded in the `generator` attribute, or stick with standard functions. See some examples in the `layouts.R` file.*
