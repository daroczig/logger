...
![colored log output](reference/figures/colors.png)
...
details, see
[`vignette("write_custom_extensions")`](https://daroczig.github.io/logger/articles/write_custom_extensions.md).
...
- By default, rely on `glue()` when it comes to formatting / rendering
  log messages, but keep it flexible if others prefer
  [`sprintf()`](https://rdrr.io/r/base/sprintf.html) (e.g. for
  performance reasons) or other functions.
...
[`vignette("migration")`](https://daroczig.github.io/logger/articles/migration.md)
useful.
