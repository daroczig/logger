# Format a log message with [`glue::glue()`](https://glue.tidyverse.org/reference/glue.html)

By default, this layout includes the log level of the log record as per
[`log_levels()`](https://daroczig.github.io/logger/reference/log_levels.md),
the current timestamp and the actual log message – that you can override
via calling
