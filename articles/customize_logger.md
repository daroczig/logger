...
log_info("Hi, there!")
#> INFO [2026-09-09 13:09:05] Hi, there!
log_debug("How are you doing today?")
log_threshold()
#> Log level: INFO
log_threshold(TRACE)
log_debug("How are you doing today?")
#> DEBUG [2026-09-09 13:09:05] How are you doing today?
```
...
log_info("no")
#> INFO [2026-09-09 13:09:05] no

with_log_threshold(log_debug("pst, can you hear me?"), threshold = TRACE)
#> DEBUG [2026-09-09 13:09:05] pst, can you hear me?
log_info("yes")
#> INFO [2026-09-09 13:09:05] yes
...
log_debug("ping")
log_level(FYI, "ping")
#> FYI [2026-09-09 13:09:05] ping
log_info("pong")
#> INFO [2026-09-09 13:09:05] pong
```
...
#> INFO [2026-09-09 13:09:06] Hi, there!
```
...
log_trace("Hi, there!", namespace = "kitchensink")
#> TRACE [2026-09-09 13:09:06] Hi, there!
log_info("Hi, there!", namespace = "kitchensink")
#> INFO [2026-09-09 13:09:06] Hi, there!
log_trace("Hi, there!")
```
...
#> INFO [2026-09-09 13:09:06] There are 32 cars in the mtcars dataset
log_info("2 + 2 = {2+2}")
#> INFO [2026-09-09 13:09:06] 2 + 2 = 4
```
...
log_info(42)
#> INFO [2026-09-09 13:09:06] 42
log_info("The answer is {42}")
#> INFO [2026-09-09 13:09:06] The answer is 42
log_info("The answers are {1:5}")
#> INFO [2026-09-09 13:09:06] The answers are 1
#> INFO [2026-09-09 13:09:06] The answers are 2
#> INFO [2026-09-09 13:09:06] The answers are 3
#> INFO [2026-09-09 13:09:06] The answers are 4
#> INFO [2026-09-09 13:09:06] The answers are 5
```
...
log_info(42)
#> {"time":"2026-09-09 13:09:06","level":"INFO","ns":"global","ans":"global","topenv":"R_GlobalEnv","fn":"eval","node":"runnervmejwal","arch":"x86_64","os_name":"Linux","os_release":"6.17.0-1022-azure","os_version":"#22-Ubuntu SMP Mon Jul 27 17:24:03 UTC 2026","pid":11200,"user":"runner","msg":"42"}
log_info("The answer is {42}")
#> {"time":"2026-09-09 13:09:06","level":"INFO","ns":"global","ans":"global","topenv":"R_GlobalEnv","fn":"eval","node":"runnervmejwal","arch":"x86_64","os_name":"Linux","os_release":"6.17.0-1022-azure","os_version":"#22-Ubuntu SMP Mon Jul 27 17:24:03 UTC 2026","pid":11200,"user":"runner","msg":"The answer is 42"}
log_info("The answers are {1:5}")
#> {"time":"2026-09-09 13:09:06","level":"INFO","ns":"global","ans":"global","topenv":"R_GlobalEnv","fn":"eval","node":"runnervmejwal","arch":"x86_64","os_name":"Linux","os_release":"6.17.0-1022-azure","os_version":"#22-Ubuntu SMP Mon Jul 27 17:24:03 UTC 2026","pid":11200,"user":"runner","msg":"The answers are 1"}
#> {"time":"2026-09-09 13:09:06","level":"INFO","ns":"global","ans":"global","topenv":"R_GlobalEnv","fn":"eval","node":"runnervmejwal","arch":"x86_64","os_name":"Linux","os_release":"6.17.0-1022-azure","os_version":"#22-Ubuntu SMP Mon Jul 27 17:24:03 UTC 2026","pid":11200,"user":"runner","msg":"The answers are 2"}
#> {"time":"2026-09-09 13:09:06","level":"INFO","ns":"global","ans":"global","topenv":"R_GlobalEnv","fn":"eval","node":"runnervmejwal","arch":"x86_64","os_name":"Linux","os_release":"6.17.0-1022-azure","os_version":"#22-Ubuntu SMP Mon Jul 27 17:24:03 UTC 2026","pid":11200,"user":"runner","msg":"The answers are 3"}
#> {"time":"2026-09-09 13:09:06","level":"INFO","ns":"global","ans":"global","topenv":"R_GlobalEnv","fn":"eval","node":"runnervmejwal","arch":"x86_64","os_name":"Linux","os_release":"6.17.0-1022-azure","os_version":"#22-Ubuntu SMP Mon Jul 27 17:24:03 UTC 2026","pid":11200,"user":"runner","msg":"The answers are 4"}
#> {"time":"2026-09-09 13:09:06","level":"INFO","ns":"global","ans":"global","topenv":"R_GlobalEnv","fn":"eval","node":"runnervmejwal","arch":"x86_64","os_name":"Linux","os_release":"6.17.0-1022-azure","os_version":"#22-Ubuntu SMP Mon Jul 27 17:24:03 UTC 2026","pid":11200,"user":"runner","msg":"The answers are 5"}
```
...
- check what’s being logged when called from the global environment:
  ...
  log_info("foo")
  #> runnervmejwal/11200/global/eval 2026-09-09 13:09:06.295937 INFO: foo
  ```
...
- check what’s being logged when called from a custom function:
  ...
  f()
  #> runnervmejwal/11200/global/f 2026-09-09 13:09:06.341684 INFO: foo
  ```
...
- check what’s being logged when called from a package:
  ...
  #> runnervmejwal/11200/logger.tester/logger_tester_function 2026-09-09 13:09:06.472545 INFO: hi from tester package 0.0807501375675201
  ```
...
- suppress messages in a namespace:
  ...
  #> runnervmejwal/11200/logger.tester/logger_tester_function 2026-09-09 13:09:06.519933 WARN: hi from tester package 0.0807501375675201
  log_info("I am still working in the global namespace")
  #> runnervmejwal/11200/global/eval 2026-09-09 13:09:06.52092 INFO: I am still working in the global namespace
  ```
...
readLines(t)
#> [1] "INFO [2026-09-09 13:09:06] where is this message going?"
unlink(t)
```
...
## test both loggers
log_info("info msg")
#> INFO [2026-09-09 13:09:06] info msg
log_debug("info msg")

readLines(t)
#> [1] "INFO [2026-09-09 13:09:06] info msg" 
#> [2] "DEBUG [2026-09-09 13:09:06] info msg"
unlink(t)
```
